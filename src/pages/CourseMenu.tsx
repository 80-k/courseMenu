...
export const CourseMenu: React.FC<CourseMenuProps> = memo(({
  isExpanded,
  toggle,
}) => {
  return (
    <div className='max-w-6xl mx-auto bg-white/80 min-h-screen shadow-2xl px-4 py-6 pb-32 md:px-8 md:py-10 md:pb-40 backdrop-blur-sm'>
      <div className='flex justify-center items-center py-3 mb-3 border-b border-gray-200/30 md:py-5 md:mb-5'>
        <img src={ASSETS.LOGO} alt='Restaurant Logo' loading="eager" className='max-w-16 h-auto object-contain opacity-90 transition-all duration-300 filter drop-shadow-lg hover:opacity-100 hover:scale-105 md:max-w-24' />
      </div>
